...
internal object GUIManager : Listener {
  ...
  fun onInventoryClose(e: InventoryCloseEvent) {
    e.inventory.ifGui { it.onClose() }
  }

  @EventHandler
  fun onInventoryDrag(e: InventoryDragEvent) {
    e.view.topInventory.ifGui { e.isCancelled = true }
  }
  ...
  fun onInventoryDragMonitor(e: InventoryDragEvent) {
    e.view.topInventory.ifGui {
      plugin.logger.log(
          Level.SEVERE, "Another plugin has un-cancelled an InventoryDragEvent, breaking KInvs")
    }
  }
  ...
  fun onInventoryClickMonitor(e: InventoryClickEvent) {
    e.view.topInventory.ifGui {
      plugin.logger.log(
          Level.SEVERE, "Another plugin has un-cancelled an InventoryClickEvent, breaking KInvs")
    }
  }
