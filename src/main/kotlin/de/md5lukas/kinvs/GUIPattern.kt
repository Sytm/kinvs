...
/**
 * A GUI pattern allows you to design inventories with characters visually instead of manually
 ...
 * @throws IllegalArgumentException If any line in the pattern does not match the length of the
 *   first line.
 */
        ...
        Array(pattern.size) {
          ...
          if (currentLine.length != columns) {
            throw IllegalArgumentException(
                "The line $it has a different length (${currentLine.length}) than the first line ($columns).")
          }
