...
/**
 * Most basic functional implementation for [GUIContent] with a fixed item and optional call back on
 * click.
 *
 ...
 */
class GUIItem(override val item: ItemStack, private val onClick: ((InventoryClickEvent) -> Unit)?) :
    GUIContent {
