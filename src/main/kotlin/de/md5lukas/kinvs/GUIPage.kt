...
/**
 * A GUIPage represents the current contents of the inventory at any given moment when the page is the [GUI.activePage]
 *
...
open class GUIPage(
    ...
    /**
     * The amount of rows this GUI page has. Same as the amount of rows the GUI has provided at creation
     */
    val rows = gui.rows
